 ...
 * 
 * O JWT Token Token é dividido em 3 partes 1.Header, 2.Payload, 3.Signature. Acesse para verificar 'https://jwt.io/'
 * Header: Algoritmo e tipo de token. 
 * Payload: Dados que vão ser trafegados. Podemos adicionar dados também.
